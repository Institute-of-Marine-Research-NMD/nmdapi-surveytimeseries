...
public class WebAppInitalizer extends AbstractDispatcherServletInitializer {
    ...
    protected WebApplicationContext createServletApplicationContext() {
        ...
        ctx.scan("no.imr.nmdapi.surveytimeseries.controller");
...
//        securityFilter.addMappingForUrlPatterns(EnumSet.allOf(DispatcherType.class), false, "/*");
        ...
        try {
            InitalizeLogbackHandler.getInstance().initalize(System.getProperty("catalina.base") + "/conf/nmdapi_surveytimeseries_logback_v1.xml", true);
