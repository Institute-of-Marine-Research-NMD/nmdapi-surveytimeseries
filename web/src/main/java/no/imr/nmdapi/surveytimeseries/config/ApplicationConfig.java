 ...
 */
@Configuration
@ComponentScan(basePackages = {"no.imr.nmdapi.surveytimeseries.config"})
...
public class ApplicationConfig {
    ...
    public org.apache.commons.configuration.Configuration configuration() throws ConfigurationException {
        org.apache.commons.configuration.PropertiesConfiguration configuration = new org.apache.commons.configuration.PropertiesConfiguration(System.getProperty("catalina.base") + "/conf/nmdapi_surveytimeseries_v1.properties");
