...
public class TestConfiguration {
    ...
    public org.apache.commons.configuration.Configuration configuration() throws ConfigurationException {
        ...
        configuration.setProperty("pre.data.dir", System.getProperty("java.io.tmpdir") + File.separator + "surveytimeseries" + File.separator);
        ...
        configuration.setProperty("app.packages", "no.imr.nmd.commons.dataset.jaxb:no.imr.nmd.commons.surveytimeseries.jaxb");
